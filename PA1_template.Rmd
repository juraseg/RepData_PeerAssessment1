...
Interval of maximum value is ```r interval```. Interval, corresponding to ```r interval``` is 8:35 - 8:40 am. So this is the most active 5-minute in day on average. Probably it's the time when a person is either going to work or on morning jogging.
